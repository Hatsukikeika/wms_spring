...
public enum ServiceClass {
	...
	private static final Map<Integer, ServiceClass> lookup = new HashMap<Integer, ServiceClass>();

	static {
		for (ServiceClass d : ServiceClass.values()) {
			lookup.put(d.numForm, d);
		}
	}

	private ServiceClass(Integer numForm, String strForm) {
	...
	public static ServiceClass get(Integer key) {
